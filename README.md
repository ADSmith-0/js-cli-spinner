...
> [!IMPORTANT]
> Remember that the speed of the animation is determined by the number of frames. If you keep the interval constant, but have less frames then it will appear faster and with more frames it will appear slower
